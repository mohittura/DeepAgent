...
from utils.prompts import TASK_DESCRIPTION_PREFIX
...
def _create_task_tool(tools, subagents: list[SubAgent], model, state_schema):
    ...
    async def task(
        ...
        # Execute the sub-agent asynchronously — enables true parallelism
        # when the parent agent calls task() multiple times in one response

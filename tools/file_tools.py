...
Note: These tools are intentionally synchronous. They perform only in-memory
dict operations on agent state — there is no I/O to await, and LangGraph
handles mixed sync/async tools correctly.
"""
